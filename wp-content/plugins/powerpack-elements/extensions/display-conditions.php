	...
	private function add_controls( $element, $args ) {
		...
		$repeater->add_control(
			...
			[
				...
				'groups' 	=> [
					...
					[
						'label'					=> __( 'Current Page', 'powerpack' ),
						'options' 				=> [
							'page' 				=> __( 'Page', 'powerpack' ),
							'post' 				=> __( 'Post', 'powerpack' ),
							'static_page' 		=> __( 'Static Page', 'powerpack' ),
							'post_type' 		=> __( 'Post Type', 'powerpack' ),
						],
					],
					[
						'label'					=> __( 'Current Archive', 'powerpack' ),
						'options' 				=> [
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' 	=> true,
				'options' 		=> [
					'home'		=> __( 'Default Homepage', 'powerpack' ),
					'static'	=> __( 'Static Homepage', 'powerpack' ),
					'blog'		=> __( 'Blog Page', 'powerpack' ),
