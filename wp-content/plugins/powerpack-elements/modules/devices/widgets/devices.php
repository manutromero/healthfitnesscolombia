...
class Devices extends Powerpack_Widget {
	...
	protected function render_video_buttons() {
		...
		$this->add_render_attribute( 'play-icon', [
			'class' => ['pp-video-button', 'pp-player-controls-play'],
		...
		<div class="pp-player-controls-overlay pp-video-player-overlay">
			<div class="pp-video-buttons">
				...
				if ( $settings['play_icon'] != '' ) {
					...
					Icons_Manager::render_icon( $settings['play_icon'], [ 'class' => ['pp-video-button', 'pp-player-controls-play'], 'aria-hidden' => 'true', 'title' => __( 'Play / Pause', 'powerpack' ) ] );
				} else {
					$this->add_render_attribute( 'play-icon', 'class', 'fa fa-play' );
					?>
