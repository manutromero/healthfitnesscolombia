...
function th_masterslider_update_check() {
    ...
    // Option Tree
    $th_plugin_dir = WP_PLUGIN_DIR . '/option-tree';
    $th_plugin_slug = 'ot-loader';

    if ( is_dir( $th_plugin_dir ) ) {
        // plugin directory found!
        $myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
            'http://import.themovation.com/live-plugin-updater/option-tree.json',
            $th_plugin_dir.'/'.$th_plugin_slug.'.php',
            $th_plugin_slug
        );
    }
...
function th_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
            ...
            'source'    => 'https://www.dropbox.com/s/wgo9cs6om06fb3n/booked.zip?dl=1', //get_template_directory() . '/plugins/th-widget-pack.zip', // The plugin source.
        ),
        array(
        ...
        array(
            ...
            'source'    => 'https://www.dropbox.com/s/ff9f1ahxacpbvlu/option-tree.zip?dl=1',
            'required'  => false,
        ),
